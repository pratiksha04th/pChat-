...
import 'package:pchat/Feature/PostScreen/view/text_preview_screen.dart';
        ...
        child: Wrap(
          children: [
            ...
            ListTile(
              ...
              title: const Text(AppStrings.scanLive),
              onTap: () async {
                Get.back();

                final file = await Get.to(() => const LiveTextScanner());
                if (file != null && file is File) {
                  final result = await Get.to(() => TextPreviewScreen(imageFile: file));
                  ...
                  if (result != null && result is String) {
                    ...
                    isTyping.value = result.trim().isNotEmpty;
